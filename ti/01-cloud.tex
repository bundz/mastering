...
tecnologias~\cite{CloudUncovered:2012} \gaaar{é bom colocar um til entre a
referência e a palavra anterior para que elas não sejam separadas}. Acredita-se que o o conceito de Computação em
Nuvem é o mesmo que John McCarthy, em 1960, se referia a habilidade de prover
e organizar computação como "commodity" \refe{segundo quem?} \gaaar{aspas são feitas com `` e ''}. 

\gaaar{o pulo para a organização da seção me parece um pouco grande. parece
faltar algo aqui no meio justificando a discussão sobre cloud.}
...
apresentados.  \gaaar{y u no label and ref? Exemplo: Na
Seção~\ref{cloud:def}\ldots}
...
nome do documento ou autores}, 22  definições diferentes de nuvem são estudadas e, a partir dessas definições, é proposta uma nova definição que contemple as demais:
